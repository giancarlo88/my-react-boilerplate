...
This is a quick boilerplate I use when building React projects. It's an ejected create-react-app that also allows testing with mocha/chai/enzyme. 

I've included the original ReadMe below for reference. 
